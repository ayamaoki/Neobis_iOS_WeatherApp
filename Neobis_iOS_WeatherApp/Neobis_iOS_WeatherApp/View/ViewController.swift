...
class ViewController: UIViewController {
    ...
    func updateUI() {
        ...
        mainView.temperatureLabel.text = "\(intTemp)°C"
        ...
        mainView.humidityStatus.text = "\(weatherModel.main.humidity)%"
        mainView.visibility.text = "\((weatherModel.visibility) / 1760) miles"
        mainView.airPressureStatus.text = "\(weatherModel.main.pressure) mb"
    ...
    func updateWeekUI() {
        ...
        mainView.view1.temperaturLabel.text = "\(Int(round(day1MaxTemp)))°C"
        ...
        if weekModel.list.count >= 16 {
            ...
            mainView.view2.temperaturLabel.text = "\(Int(round(day2MaxTemp)))°C"
        ...
        if weekModel.list.count >= 24 {
            ...
            mainView.view3.temperaturLabel.text = "\(Int(round(day3MaxTemp)))°C"
        ...
        if weekModel.list.count >= 32 {
            ...
            mainView.view4.temperaturLabel.text = "\(Int(round(day4MaxTemp)))°C"
        ...
        if weekModel.list.count >= 40 {
            ...
            mainView.view5.temperaturLabel.text = "\(Int(round(day5MaxTemp)))°C"
